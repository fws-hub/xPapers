...
columns =>
    [
        ...
        input6m => { type => 'integer' , default=> 0},
        inputu => { type => 'integer' , default=> 0},
        inputu6m => { type => 'integer' , default=> 0},
        output => { type => 'integer' , default=> 0},
        output6m => { type => 'integer' , default=> 0},
        added => { type => 'integer', default=> 0},
        entryCount => { type => 'integer', default=> 0},
        entryCountUnder => { type => 'integer', default=> 0},
        lastAdded => { type => 'datetime' },
