...
$TAR = "/bin/tar";
$GZIP = "/bin/gzip";
$IP_BLOCK_CMD = "sudo /sbin/iptables -A INPUT -s %s -j DROP";
...
$SUBJECT = 'Philosophy';
$SUBJECT_PRACTITIONER = 'philosopher';
$SUBJECT_PRACTITIONER_PLURAL = 'philosophers';
$PUBLIC_ERRORS = 0;
