...
if ($ARGS{c} eq "reverseDiff") {
    ...
    jserror("You have reached your quota of categorization for today, sorry") if $user->danger("CatAdd");
    eval {
    ...
    jserror("You have reached your quota of categorization for today, sorry") if $user->danger("CatAdd",$#ents+1);
    for (@ents) {
        next unless $_;
    ...
    jserror("You have reached your quota of categorization for today, sorry") if $user->danger("CatDelete");
