...
print "$s->{niceName} has over *** categories, ranging from broad areas to narrow subtopics. Choose the area where you would like to start browsing below, or <a href='/browse/all'>view all categories</a>.<p> ";
...
<a href="/help/categorization.html">Read more</a> about the Categorization Project.
