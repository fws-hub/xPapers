...
is( bareName("David J Bourget"),"Bourget, David","Bare name 1" );
is( bareName("David Joseph Richard Bourget"),"Bourget, David","Bare name 2" );
is( bareName("Bourget, David"),"Bourget, David","Bare name 3" );
is( bareName("Bourget, David J."),"Bourget, David", "Bare name 4");
